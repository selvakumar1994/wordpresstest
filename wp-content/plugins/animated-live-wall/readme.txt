=== Animated Live Wall - Social Feed - Gallery ===
Contributors: awordpresslife
Donate link: https://awplife.com/
Tags: Instagram, Flickr, gallery, responsive gallery, animation
...
Animated live wall gallery creates a media wall with animated switching blocks that run at a specific time interval.
...
* [Live Demo](https://awplife.com/demo/animated-live-wall-premium/)
...
3. Animated grid gallery with Instagram Feed
4. Animated grid gallery with Flickr Feed
5. Masonry Layout
6. Configuration
