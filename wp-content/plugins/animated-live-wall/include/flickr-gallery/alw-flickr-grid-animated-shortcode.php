		...
		<div id="ri-grid-<?php echo $alw_id; ?>" class="ri-grid ri-grid-size-2">
			...
			if($flickr_data) {
				...
				foreach($flickr_data as $flickr_data_res) {
					...
					//set thumbnail size
					if($alw_grid_thumb_size == "thumbnail") { $thumbnail_url = $flickr_data_res['url_q']; }
					if($alw_grid_thumb_size == "medium") { $thumbnail_url = $flickr_data_res['url_s']; }
					if($alw_grid_thumb_size == "large") { $thumbnail_url = $flickr_data_res['url_m']; }
					if($alw_grid_thumb_size == "full") { $thumbnail_url = $flickr_data_res['url_l']; }
					
					$photo_id = $flickr_data_res['id']; 
					
					?>
					<li class="brick">
						<a class="snip1467" href="https://www.flickr.com/photos/<?php echo $alw_flickr_user_id; ?>/<?php echo $photo_id; ?>/">
